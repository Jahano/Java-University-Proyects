...
public class Materia extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTextArea1.setFont(new java.awt.Font("Vivaldi", 3, 18)); // NOI18N
        jTextArea1.setForeground(new java.awt.Color(255, 255, 255));
        jTextArea1.setRows(5);
        jTextArea1.setText("Materia: Topicos Avanzados de Programacion. \nProfesor: Ivan Pedraza \nInstituto Tecnologico de Iztapalapa.");
        jScrollPane1.setViewportView(jTextArea1);

        jLabel1.setBackground(new java.awt.Color(0, 0, 0));
        jLabel1.setFont(new java.awt.Font("Vivaldi", 3, 24)); // NOI18N
        jLabel1.setForeground(new java.awt.Color(255, 255, 255));
        jLabel1.setText("Informacion de la Materia:");
